...
#Minimax algorithm
#Finds the best possible move for the current player (dependent on depth limit)
#returns (value, position of best move)
...
#Running Program and outputing solution to txt file
